  ...
  html: `
    <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; padding: 30px; border: 1px solid #eaeaea; border-radius: 10px; background-color: #ffffff;">
      ...
      <div style="padding: 30px 0;">
        <p style="font-size: 16px; color: #333333; margin-bottom: 20px;">Hello ${userName},</p>
      ...
      <div style="text-align: center; padding-top: 20px; border-top: 1px solid #eaeaea; font-size: 13px; color: #999999;">
        <p style="margin-bottom: 5px;">Need help? Contact us at <a href="mailto:support@nxtship.in" style="color: #0056b3; text-decoration: none;">support@nxtship.in</a></p>
        <p style="margin: 0;">&copy; 2026 NXTShip.in. All rights reserved.</p>
      </div>
    </div>
  `,
});
